...
function getBotResponse(text) {
  botResponse = `<img class="botAvatar" src="./static/img/KanGuruSmall.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
  return botResponse;
}
...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const fallbackMsg = "Sorry, aber ich habe dich nicht verstanden. Probier es nochmal bitte ☺️";

      const BotResponse = `<img class="botAvatar" src="./static/img/KanGuruSmall.png"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            if (
              ...
              if (!botResponse) {
                botResponse = `<img class="botAvatar" src="./static/img/KanGuruSmall.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
              }
            }
